var e=window.jQuery,t=window.AOS,n=window.createREGL,r=function(){let e=document.querySelector(`#webgl`),t=0,r=n({canvas:e,onDone(e,t){e&&alert(`申し訳ございません。只今メンテナンス中です。`)}}),i=new Image;i.src=`img/gradient_map3.png`,i.onload=function(){setTimeout(()=>{document.body.classList.remove(`loading`)},1e3);let n=r({frag:`
