    ...
    >
      ...
      >
        <div style={{ alignSelf: 'center', maxWidth: 820 }}>
          ...
          >
            <span style={{
              display: 'block', color: 'var(--kincha)', fontSize: '.6em', letterSpacing: '.4em', marginBottom: 18,
            }}
            >
              し か の や ど
            </span>
      ...
      >
        <div className="fade">
          ...
          >
            ...
            <div>
              <div style={{
                fontFamily: 'var(--serif)', fontSize: 16, letterSpacing: '.1em', marginBottom: 4, color: 'var(--kinari)',
              }}
              >
                五代目 女将　南都 美和
              </div>
              <div style={{
                fontFamily: 'var(--mono)', fontSize: 11, letterSpacing: '.18em', color: 'var(--kincha)',
              }}
              >
    ...
    <section ref={ref} id="rooms" style={{ background: 'var(--washi)' }}>
      <div className="wrap">
        ...
        <div
          className="fade"
          style={{
            display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 32, marginBottom: 80,
          }}
        >
          <Placeholder
          ...
          >
            <div>
              ...
              <h3 style={{
                fontFamily: 'var(--serif)', fontSize: 30, fontWeight: 600, margin: '0 0 18px', letterSpacing: '.06em',
              }}
              >
                離れ「鹿苑」
              </h3>
            ...
            <div style={{
              marginTop: 28, borderTop: '1px solid var(--line)', paddingTop: 20, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, fontFamily: 'var(--mono)', fontSize: 11, letterSpacing: '.14em',
            }}
            >
              <div>
...
　¥58,000〜 / 人
        ...
        >
          {[
            ...
            <div key={r.en}>
              ...
              >
                <h4 style={{
                  fontFamily: 'var(--serif)', fontSize: 20, fontWeight: 600, margin: 0, letterSpacing: '.06em',
                }}
                >
                  {r.jp}
                </h4>
                <span style={{
                  fontFamily: 'var(--mono)', fontSize: 11, letterSpacing: '.18em', color: 'var(--aka)',
                }}
                >
                  {r.price}
                </span>
        ...
        <div
          ...
          className="fade"
          style={{
            display: 'grid', gridTemplateColumns: '1fr 1.3fr', gap: 56, alignItems: 'center', marginBottom: 96,
          }}
        >
          <div>
            <span className="num" style={{ display: 'block', marginBottom: 18 }}>— CUISINE / 御料理</span>
            <h3 style={{
              fontFamily: 'var(--serif)', fontSize: 30, fontWeight: 600, margin: '0 0 22px', letterSpacing: '.06em', lineHeight: 1.4,
            }}
            >
              月替わりの会席、
              <br />
            ...
            <div style={{
              display: 'flex', gap: 28, flexWrap: 'wrap', paddingTop: 18, borderTop: '1px solid var(--line)',
            }}
            >
          ...
          {items.map((it) => (
            ...
            >
              ...
              >
                ...
                <span style={{
                  fontFamily: 'var(--mono)', fontSize: 10, letterSpacing: '.22em', color: 'rgba(244,239,230,.5)',
                }}
                >
                  {it.en}
                </span>
              ...
              <h3 style={{
                fontFamily: 'var(--serif)', fontSize: 19, fontWeight: 600, margin: '0 0 14px', color: 'var(--kinari)', lineHeight: 1.55, letterSpacing: '.04em',
              }}
              >
                {it.jp}
              </h3>
      ...
      <div className="wrap">
        ...
        >
          {stats.map((s, i) => (
            ...
            >
              <div style={{
                fontFamily: 'var(--serif)', fontWeight: 500, fontSize: 52, letterSpacing: '.02em', lineHeight: 1, color: 'var(--aka)',
              }}
              >
                {s.n}
                <span style={{
                  fontSize: 18, marginLeft: 4, color: 'var(--sumi-2)', fontWeight: 400,
                }}
                >
                  {s.u}
                </span>
        ...
        <div className="fade" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 28 }}>
          {reviews.map((r, i) => (
            ...
            >
              ...
              <h4 style={{
                fontFamily: 'var(--serif)', fontWeight: 600, fontSize: 18, margin: 0, lineHeight: 1.55,
              }}
              >
                「
                {r.title}
              ...
              <div style={{ borderTop: '1px solid var(--line)', paddingTop: 14, marginTop: 4 }}>
                ...
                <div style={{
                  fontFamily: 'var(--mono)', fontSize: 10.5, letterSpacing: '.14em', color: 'var(--sumi-2)', opacity: 0.7, marginTop: 4,
                }}
                >
                  {r.stay}
                </div>
        ...
        <div className="fade" style={{ marginTop: 72, paddingTop: 28, borderTop: '1px solid var(--line)' }}>
          <div
            className="body-sm"
            style={{
              marginBottom: 18, letterSpacing: '.18em', fontFamily: 'var(--mono)', fontSize: 11,
            }}
          >
            掲載 — AS FEATURED IN
          </div>
          <div style={{
            display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 24, alignItems: 'center',
          }}
          >
      ...
      <div className="wrap">
        ...
        <div className="fade" style={{ position: 'relative' }}>
          {steps.map((s, i) => (
            ...
            >
              <div style={{
                fontFamily: 'var(--serif)', fontSize: 44, fontWeight: 500, color: 'var(--aka)', letterSpacing: '.04em',
              }}
              >
                {s.n}
              </div>
              <div>
                <h3 style={{
                  fontFamily: 'var(--serif)', fontSize: 22, fontWeight: 600, margin: '0 0 8px', letterSpacing: '.06em',
                }}
                >
                  {s.title}
                </h3>
              ...
              <div style={{
                textAlign: 'right', fontFamily: 'var(--mono)', fontSize: 12, letterSpacing: '.18em', color: 'var(--sumi-2)',
              }}
              >
                {s.time}
              </div>
            ...
            return (
              <div key={i} style={{ borderBottom: '1px solid var(--line)' }}>
                ...
                >
                  ...
                  <span style={{
                    fontFamily: 'var(--serif)', fontSize: 17, fontWeight: 500, letterSpacing: '.04em', lineHeight: 1.55,
                  }}
                  >
                    {it.q}
                  </span>
