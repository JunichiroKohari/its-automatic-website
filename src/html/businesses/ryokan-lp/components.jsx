...
function Placeholder({ label, tone = "light", style = {}, className = "" }) {
  return (
    <div
  ...
  return (
    <nav className="nav">
      <div className="nav__brand">
        <span className="crest" aria-hidden="true">鹿</span>
        <span>鹿乃宿</span>
      </div>
      ...
      <button className="nav__cta" onClick={onReserve}>ご予約</button>
    </nav>
  );
}
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", inset: 0 }}>
        <Placeholder
          tone="dark"
          label="VIDEO  /  奈良公園の朝霧と鹿の群れ・若草山を望むループ動画 (1920×1080, 12s)"
      ...
      >
        <div style={{ alignSelf: "center", maxWidth: 820 }}>
          ...
          >
            <span style={{ display: "block", color: "var(--kincha)", fontSize: ".6em", letterSpacing: ".4em", marginBottom: 18 }}>
              し か の や ど
            </span>
            門を出れば、鹿。
            <br />
        ...
        >
          <div>
            <div style={{ color: "var(--kincha)", marginBottom: 6 }}>01 / LOCATION</div>
            <div>奈良公園 徒歩3分</div>
          </div>
          <div>
            <div style={{ color: "var(--kincha)", marginBottom: 6 }}>02 / SINCE</div>
            <div>明治二十五年創業</div>
          </div>
          <div>
            <div style={{ color: "var(--kincha)", marginBottom: 6 }}>03 / ROOMS</div>
            <div>全12室・離れあり</div>
          </div>
          <div>
            <div style={{ color: "var(--kincha)", marginBottom: 6 }}>04 / RATING</div>
            <div>★ 4.86 / 1,240件</div>
          </div>
        </div>
      </div>
      ...
      <div className="wrap">
        <div className="section-head fade">
          <div className="section-head__meta">
            ...
            <span className="vtext" style={{ fontSize: 12, opacity: 0.5, color: "var(--sumi-2)" }}>
              旅の悩み
            </span>
          </div>
...
function Empathy() {
  ...
  return (
    <section ref={ref} className="dark" id="empathy">
      <div className="wrap" style={{ display: "grid", gridTemplateColumns: "1.05fr 1fr", gap: 80, alignItems: "center" }}>
        <div className="fade">
          <span className="eyebrow" style={{ marginBottom: 24 }}>03 — EMPATHY</span>
          <h2 className="h-section" style={{ color: "var(--kinari)", marginTop: 18, marginBottom: 28 }}>
            分かります。
            <br />
            私たちも、同じ景色を見てきました。
          </h2>
          <p className="body-lg" style={{ color: "rgba(244,239,230,.82)", marginBottom: 22 }}>
            この宿で五代続く女将もまた、年に何度も観光地の喧騒を目にしてきました。
            けれど、奈良の本当の魅力は、観光客が動き出す前の朝六時にあります。
          </p>
          <p className="body-lg" style={{ color: "rgba(244,239,230,.82)", margin: 0 }}>
          ...
          >
            <Placeholder
              tone="dark"
              label="女将 portrait, 60×80"
              style={{ width: 60, height: 80, flex: "0 0 auto" }}
            />
            <div>
              <div style={{ fontFamily: "var(--serif)", fontSize: 16, letterSpacing: ".1em", marginBottom: 4, color: "var(--kinari)" }}>
                五代目 女将　南都 美和
              </div>
              <div style={{ fontFamily: "var(--mono)", fontSize: 11, letterSpacing: ".18em", color: "var(--kincha)" }}>
        ...
        <div className="fade" style={{ position: "relative" }}>
          <Placeholder
            tone="dark"
            label="PHOTO  /  夜明けの奈良公園、鹿と石灯籠 (縦4:5)"
          ...
          >
            <div>
              <div className="vtext" style={{ fontSize: 22, color: "var(--kincha)", letterSpacing: ".5em" }}>
                朝六時の奈良
              </div>
            </div>
          </div>
  ...
  return (
    <section ref={ref} id="about" style={{ background: "var(--kinari)" }}>
      <div className="wrap">
        ...
        >
          {pillars.map((p) => (
            <div key={p.en} style={{ borderTop: "1px solid var(--sumi)", paddingTop: 24 }}>
              <Placeholder
                label={`PHOTO  /  ${p.en}`}
                style={{ width: "100%", aspectRatio: "4/3", marginBottom: 24 }}
              />
  ...
  return (
    <section ref={ref} id="rooms" style={{ background: "var(--washi)" }}>
      <div className="wrap">
        ...
        {/* Big room hero */}
        <div className="fade" style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 32, marginBottom: 80 }}>
          <Placeholder
            label="PHOTO  /  離れ「鹿苑」十畳＋広縁、若草山ビュー (横16:10)"
            style={{ width: "100%", aspectRatio: "16/10" }}
          />
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "12px 0" }}>
            <div>
              <div className="num" style={{ marginBottom: 14 }}>SUITE / 鹿苑 ROKUEN</div>
              <h3 style={{ fontFamily: "var(--serif)", fontSize: 30, fontWeight: 600, margin: "0 0 18px", letterSpacing: ".06em" }}>
                離れ「鹿苑」
              </h3>
            ...
            <div style={{ marginTop: 28, borderTop: "1px solid var(--line)", paddingTop: 20, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, fontFamily: "var(--mono)", fontSize: 11, letterSpacing: ".14em" }}>
              <div><span style={{ color: "var(--aka)" }}>定員</span>　最大4名</div>
              <div><span style={{ color: "var(--aka)" }}>広さ</span>　64㎡ + 露天</div>
              <div><span style={{ color: "var(--aka)" }}>食事</span>　部屋食</div>
              <div><span style={{ color: "var(--aka)" }}>料金</span>　¥58,000〜 / 人</div>
            </div>
          </div>
        </div>
        ...
        >
          {[
            { jp: "本館・松", en: "MATSU", desc: "十畳の標準和室、檜の内風呂。", price: "¥28,000〜" },
            { jp: "本館・竹", en: "TAKE", desc: "十二畳＋次の間、二名様に最適。", price: "¥34,000〜" },
            { jp: "特別室・梅", en: "UME", desc: "二間続き、専用の坪庭付き。", price: "¥46,000〜" },
          ].map((r) => (
            <div key={r.en}>
              <Placeholder
                label={`PHOTO  /  客室 ${r.en}`}
                style={{ width: "100%", aspectRatio: "5/4", marginBottom: 18 }}
              />
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8 }}>
                <h4 style={{ fontFamily: "var(--serif)", fontSize: 20, fontWeight: 600, margin: 0, letterSpacing: ".06em" }}>
                  {r.jp}
                </h4>
                <span style={{ fontFamily: "var(--mono)", fontSize: 11, letterSpacing: ".18em", color: "var(--aka)" }}>
                  {r.price}
                </span>
              </div>
              <p className="body-sm" style={{ margin: 0 }}>{r.desc}</p>
            </div>
          ))}
        </div>

        {/* Cuisine */}
        <div id="cuisine" className="fade" style={{ display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: 56, alignItems: "center", marginBottom: 96 }}>
          <div>
            <span className="num" style={{ display: "block", marginBottom: 18 }}>— CUISINE / 御料理</span>
            <h3 style={{ fontFamily: "var(--serif)", fontSize: 30, fontWeight: 600, margin: "0 0 22px", letterSpacing: ".06em", lineHeight: 1.4 }}>
              月替わりの会席、
              <br />大和の旬を、ひと皿ずつ。
            </h3>
            ...
            <div style={{ display: "flex", gap: 28, flexWrap: "wrap", paddingTop: 18, borderTop: "1px solid var(--line)" }}>
              {["大和肉鶏", "宇陀の朝採れ野菜", "三輪素麺", "奈良漬", "地酒6種"].map((t) => (
                <span key={t} style={{ fontFamily: "var(--serif)", fontSize: 14, letterSpacing: ".1em" }}>
                  — {t}
                </span>
              ))}
            </div>
          ...
          <Placeholder
            label="PHOTO  /  会席・先付 / 八寸 / 椀物 横長 (16:10)"
            style={{ width: "100%", aspectRatio: "16/10" }}
          />
        </div>

        {/* Onsen */}
        <div className="fade" style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: 56, alignItems: "center" }}>
          <Placeholder
            label="PHOTO  /  檜の大浴場・夜の湯気と灯り (16:10)"
            style={{ width: "100%", aspectRatio: "16/10" }}
          />
          <div>
            <span className="num" style={{ display: "block", marginBottom: 18 }}>— ONSEN / 大浴場</span>
            <h3 style={{ fontFamily: "var(--serif)", fontSize: 30, fontWeight: 600, margin: "0 0 22px", letterSpacing: ".06em", lineHeight: 1.4 }}>
              檜の大浴場と、星を見る露天風呂。
            </h3>
            <p className="body" style={{ margin: 0 }}>
      ...
      <div className="wrap">
        <div className="section-head fade">
          <div className="section-head__meta">
            ...
            <span className="vtext" style={{ fontSize: 12, color: "rgba(244,239,230,.45)" }}>
              鹿乃宿の六つの強み
            </span>
          </div>
          <div className="section-head__title">
          ...
          {items.map((it) => (
            ...
            >
              <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 18 }}>
                <span className="num" style={{ color: "var(--kincha)" }}>{it.n}</span>
                <span style={{ fontFamily: "var(--mono)", fontSize: 10, letterSpacing: ".22em", color: "rgba(244,239,230,.5)" }}>
                  {it.en}
                </span>
              </div>
              <h3 style={{ fontFamily: "var(--serif)", fontSize: 19, fontWeight: 600, margin: "0 0 14px", color: "var(--kinari)", lineHeight: 1.55, letterSpacing: ".04em" }}>
                {it.jp}
              </h3>
              <p className="body-sm" style={{ margin: 0, color: "rgba(244,239,230,.7)" }}>{it.body}</p>
            </div>
          ))}
        </div>
      ...
      <div className="wrap">
        ...
        >
          {stats.map((s, i) => (
            ...
            >
              <div style={{ fontFamily: "var(--serif)", fontWeight: 500, fontSize: 52, letterSpacing: ".02em", lineHeight: 1, color: "var(--aka)" }}>
                {s.n}
                <span style={{ fontSize: 18, marginLeft: 4, color: "var(--sumi-2)", fontWeight: 400 }}>{s.u}</span>
              </div>
              <div className="body-sm" style={{ marginTop: 12 }}>{s.l}</div>
            </div>
          ))}
        </div>

        {/* reviews */}
        <div className="fade" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 28 }}>
          {reviews.map((r, i) => (
            <article
              key={i}
              style={{
            ...
            >
              <div style={{ letterSpacing: ".25em", color: "var(--aka)", fontSize: 14 }}>
                ★★★★★
              </div>
              <h4 style={{ fontFamily: "var(--serif)", fontWeight: 600, fontSize: 18, margin: 0, lineHeight: 1.55 }}>
                「{r.title}」
              </h4>
              <p className="body-sm" style={{ margin: 0, flex: 1 }}>{r.body}</p>
              <div style={{ borderTop: "1px solid var(--line)", paddingTop: 14, marginTop: 4 }}>
                <div style={{ fontFamily: "var(--serif)", fontSize: 13, letterSpacing: ".06em" }}>{r.who}</div>
                <div style={{ fontFamily: "var(--mono)", fontSize: 10.5, letterSpacing: ".14em", color: "var(--sumi-2)", opacity: 0.7, marginTop: 4 }}>
                  {r.stay}
                </div>
              </div>
            </article>
        ...
        {/* press logos */}
        <div className="fade" style={{ marginTop: 72, paddingTop: 28, borderTop: "1px solid var(--line)" }}>
          <div className="body-sm" style={{ marginBottom: 18, letterSpacing: ".18em", fontFamily: "var(--mono)", fontSize: 11 }}>
            掲載 — AS FEATURED IN
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 24, alignItems: "center" }}>
            {["家庭画報", "サライ", "Discover Japan", "じゃらん", "Travel + Leisure"].map((p) => (
              <div
                key={p}
                style={{
                  fontFamily: "var(--serif)",
...
function Flow({ onReserve }) {
  const ref = useReveal();
  const steps = [
    { n: "01", title: "ご予約", body: "公式サイトからご希望の日付・お部屋を選び、ご予約フォームに進みます。所要約3分。", time: "3分" },
    { n: "02", title: "ご確認メール", body: "ご予約直後と前日に、確認メールをお送りします。送迎・お食事制限のご相談はこちらに返信ください。", time: "即時" },
    { n: "03", title: "ご到着・チェックイン", body: "15時よりチェックイン。JR奈良駅からは無料送迎をご利用ください。ご到着前のお荷物預かりも可能。", time: "15:00〜" },
    { n: "04", title: "ご滞在", body: "お部屋でひと息ついた後、奈良公園へお散歩を。夕食は18:00〜、朝食は7:30〜（応相談）。", time: "—" },
    { n: "05", title: "チェックアウト", body: "11:00までゆっくりと。お見送り後、ご希望の方には駅まで送迎いたします。", time: "〜11:00" },
  ];
  return (
      ...
      <div className="wrap">
        ...
        <div className="fade" style={{ position: "relative" }}>
          {steps.map((s, i) => (
            ...
            >
              <div style={{ fontFamily: "var(--serif)", fontSize: 44, fontWeight: 500, color: "var(--aka)", letterSpacing: ".04em" }}>
                {s.n}
              </div>
              <div>
                <h3 style={{ fontFamily: "var(--serif)", fontSize: 22, fontWeight: 600, margin: "0 0 8px", letterSpacing: ".06em" }}>
                  {s.title}
                </h3>
                <p className="body" style={{ margin: 0 }}>{s.body}</p>
              </div>
              <div style={{ textAlign: "right", fontFamily: "var(--mono)", fontSize: 12, letterSpacing: ".18em", color: "var(--sumi-2)" }}>
                {s.time}
              </div>
            </div>
          ))}
    ...
    <section ref={ref} id="faq" style={{ background: "var(--kinari)" }}>
      <div className="wrap-narrow">
        <div className="fade" style={{ textAlign: "center", marginBottom: 56 }}>
          <span className="num" style={{ display: "block", marginBottom: 18 }}>09 — FAQ</span>
            ...
            return (
              <div key={i} style={{ borderBottom: "1px solid var(--line)" }}>
                ...
                >
                  ...
                  <span style={{ fontFamily: "var(--serif)", fontSize: 17, fontWeight: 500, letterSpacing: ".04em", lineHeight: 1.55 }}>
                    {it.q}
                  </span>
                  <span
                    style={{
                ...
                >
                  <div style={{ padding: "0 4px 28px 60px" }}>
                    <p className="body" style={{ margin: 0 }}>{it.a}</p>
                  </div>
                </div>
              </div>
            );
...
Object.assign(window, {
  TopNav, Hero, Problem, Empathy, Solution,
  Service, Strengths, Voice, Flow, FAQ,
  Placeholder, useReveal,
});
